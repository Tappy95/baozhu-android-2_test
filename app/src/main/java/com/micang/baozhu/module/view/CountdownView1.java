...
public class CountdownView1 extends LinearLayout {
    ...
    private CountdownView1.OnCountdownEndListener mOnCountdownEndListener;
    private HashMap<Integer, Long> timeMap;
    private TextView tv_des;
    private TextView tv_left_time;

    public CountdownView1(Context var1) {
        this(var1, (AttributeSet) null);
    }

    public CountdownView1(Context var1, AttributeSet var2) {
        this(var1, var2, 0);
    }

    public CountdownView1(Context var1, AttributeSet var2, int var3) {
    ...
    private void initView(Context context, AttributeSet attributeset) {
        LayoutInflater.from(context).inflate(R.layout.countdown_view_1, this, true);
    ...
    public void setOnCountdownEndListener(CountdownView1.OnCountdownEndListener var1) {
    ...
    public void start(long var1) {
        ...
        this.mCustomCountDownTimer = new CustomCountDownTimer(var1, this.countDownInterval) {
            public void onFinish() {
                if (CountdownView1.this.mOnCountdownEndListener != null) {
                    CountdownView1.this.mOnCountdownEndListener.onEnd(CountdownView1.this);
                }

            }

            public void onTick(long var1) {
                CountdownView1.this.updateShow(var1);
            }
        };
    ...
    public void start(long var1, final int var3) {
        ...
        this.mCustomCountDownTimer = new CustomCountDownTimer(var1, this.countDownInterval) {
            ...
            public void onTick(long var1) {
                CountdownView1.this.updateShow(var1);
                CountdownView1.this.updateShow(var1, var3);
            }
        };
    ...
    public interface OnCountdownEndListener {
        void onEnd(CountdownView1 var1);
    }
}