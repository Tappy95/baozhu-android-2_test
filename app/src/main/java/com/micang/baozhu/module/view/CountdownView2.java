...
public class CountdownView2 extends LinearLayout {
    ...
    private CountdownView2.OnCountdownEndListener mOnCountdownEndListener;
    private HashMap<Integer, Long> timeMap;
    private TextView tv_des;
    private TextView tv_left_time;

    public CountdownView2(Context var1) {
        this(var1, (AttributeSet)null);
    }

    public CountdownView2(Context var1, AttributeSet var2) {
        this(var1, var2, 0);
    }

    public CountdownView2(Context var1, AttributeSet var2, int var3) {
    ...
    private void initView(Context context, AttributeSet attributeset) {
        LayoutInflater.from(context).inflate(R.layout.countdown_view_2, this, true);
    ...
    public void setOnCountdownEndListener(CountdownView2.OnCountdownEndListener var1) {
    ...
    public void start(long var1) {
        ...
        this.mCustomCountDownTimer = new CustomCountDownTimer(var1, this.countDownInterval) {
            public void onFinish() {
                if (CountdownView2.this.mOnCountdownEndListener != null) {
                    CountdownView2.this.mOnCountdownEndListener.onEnd(CountdownView2.this);
                }

            }

            public void onTick(long var1) {
                CountdownView2.this.updateShow(var1);
            }
        };
    ...
    public void start(long var1, final int var3) {
        ...
        this.mCustomCountDownTimer = new CustomCountDownTimer(var1, this.countDownInterval) {
            ...
            public void onTick(long var1) {
                CountdownView2.this.updateShow(var1);
                CountdownView2.this.updateShow(var1, var3);
            }
        };
    ...
    public interface OnCountdownEndListener {
        void onEnd(CountdownView2 var1);
    }
}