...
public class SearchGameListAdapter extends BaseQuickAdapter<GameBean.ListBean, BaseViewHolder> {

    public SearchGameListAdapter(int layoutResId, @Nullable List<GameBean.ListBean> data) {
