...
@BindEventBus
public class SignMakeMYGameDetailActivity extends BaseActivity {
...
//        agentWeb.getJsAccessEntrace().quickCallJs("OpenApp_Return", "0");
    ...
    public class AndroidInterface {
        public AndroidInterface(AgentWeb agentWeb, SignMakeMYGameDetailActivity gameDetailsActivity) {
        }
        ...
        public String InstallAPP(String urls) {
            openBrowser(SignMakeMYGameDetailActivity.this, urls);
            return urls;
        }
    }
