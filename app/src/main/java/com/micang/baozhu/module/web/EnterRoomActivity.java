...
public class EnterRoomActivity extends BaseActivity {
    ...
    private void initAgentWeb() {
        ...
        agentWeb = AgentWeb.with(this)
                ...
                .createAgentWeb()
                .ready()
                .go(RetrofitUtils.H5url + "/againstTheProblemSolvingTwo.html" + "?token=" + token + "&imei=" + imei + "&coin=" + coin + "&entryCode=" + enterCode);
    ...
    public class AndroidInterface {
        public AndroidInterface(AgentWeb agentWeb, EnterRoomActivity enterRoomActivity) {
        }
