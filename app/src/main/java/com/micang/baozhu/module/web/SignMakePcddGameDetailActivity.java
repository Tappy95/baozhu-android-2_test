...
@BindEventBus
public class SignMakePcddGameDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        tv_start_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //存在立即打开
                final boolean isInstalled = SystemUtil.isAppInstalled(SignMakePcddGameDetailActivity.this, packagenameLocal);
                if (isInstalled) {
    ...
    private void initWebView() {
        ...
        webView.addJavascriptInterface(SignMakePcddGameDetailActivity.this, "android");
    }
    ...
    public void CheckInstall(final String packageName) {
        ...
        final boolean isInstalled = SystemUtil.isAppInstalled(SignMakePcddGameDetailActivity.this, packageName);
        if (isInstalled) {
            webView.post(new Runnable() {
                @Override
                public void run() {
...
//            Toast.makeText(this, message, Toast.LENGTH_SHORT).show();
    ...
    public void openBrowser(String url) {
        openBrowser(SignMakePcddGameDetailActivity.this, url);
    }
...
//            Log.i("url:", "");
    ...
    protected void installAPK(File file, String apkName) {
        ...
        Uri uri;
        if (SignMakePcddGameDetailActivity.this == null || SignMakePcddGameDetailActivity.this.isFinishing()) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            new RxPermissions(SignMakePcddGameDetailActivity.this).request(Manifest.permission.REQUEST_INSTALL_PACKAGES).subscribe(new Consumer<Boolean>() {
                @Override
                public void accept(Boolean aBoolean) throws Exception {
                    if (aBoolean) {
                        ...
                        Toast.makeText(SignMakePcddGameDetailActivity.this, "未授权权限，部分功能不能使用", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            File newPath = new File(SignMakePcddGameDetailActivity.this.getFilesDir().getPath() + "/downloads");
            if (!newPath.exists()) {
            ...
            mPermissionDialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("设置", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Uri packageURI = Uri.parse("package:" + getPackageName(SignMakePcddGameDetailActivity.this));
