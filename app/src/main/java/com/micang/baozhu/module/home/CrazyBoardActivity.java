...
@BindEventBus
public class CrazyBoardActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Override
    public int layoutId() {
        return R.layout.activity_crazy_board;
    }
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if ("PCDD".equals(interfaceName)) {
                    HttpUtils.toPlay(mobile, gameId).enqueue(new Observer<BaseResult>() {
                        ...
                        public void onSuccess(BaseResult response) {
                            ...
                            Intent intent = new Intent(CrazyBoardActivity.this, PCddGameDetailActivity.class);
                ...
                if ("MY".equals(interfaceName)) {
                    HttpUtils.toPlay(mobile, gameId).enqueue(new Observer<BaseResult>() {
                        ...
                        public void onSuccess(BaseResult response) {
                            String url = (String) response.data;
                            Intent intent = new Intent(CrazyBoardActivity.this, MYGameDetailsActivity.class);
                            intent.putExtra("URLS", url);
                            intent.putExtra("bean", listBean);
                            startActivity(intent);
                        }
                ...
                if ("xw-Android".equals(interfaceName)) {
                    HttpUtils.toPlay(mobile, gameId).enqueue(new Observer<BaseResult>() {
                        ...
                        public void onSuccess(BaseResult response) {
                            String url = (String) response.data;
                            Intent intent = new Intent(CrazyBoardActivity.this, XWGameDetailActivity.class);
                            intent.putExtra("URLS", url);
                            intent.putExtra("bean", listBean);
                            startActivity(intent);
                        }
