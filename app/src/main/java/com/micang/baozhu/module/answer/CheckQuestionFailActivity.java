...
public class CheckQuestionFailActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Override
    public int layoutId() {
        return R.layout.activity_check_question_fail;
    }
    ...
    private void setData(QuestionTopResult.QuestionBean question, List<QuestionTopResult.AnswerBean> answer) {
        ...
        String rejectReason = question.rejectReason;
        tvCause.setText(rejectReason);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_back:
                ...
                break;
            case R.id.bt_submit:
                startActivity(new Intent(CheckQuestionFailActivity.this, SetQuestionActivity.class));
                finish();
                break;
