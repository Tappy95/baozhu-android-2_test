 ...
 * @describe 已预约
 */
public class CheckProgress4Fragment extends BaseLazyFragment {
    ...
    protected void init(View rootView) {
        TLog.d("fragment", "CheckProgress4Fragment");
        ...
        adapter = new CheckProgress1Adapter(R.layout.item_checkprogress4, list, 5);
