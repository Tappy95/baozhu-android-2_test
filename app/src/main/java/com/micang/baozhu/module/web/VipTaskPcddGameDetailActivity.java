...
public class VipTaskPcddGameDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        tv_start_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //存在立即打开
                final boolean isInstalled = SystemUtil.isAppInstalled(VipTaskPcddGameDetailActivity.this, packagenameLocal);
                if (isInstalled) {
    ...
    private void initWebView() {
        ...
        webView.addJavascriptInterface(VipTaskPcddGameDetailActivity.this, "android");
    }
    ...
    public void CheckInstall(final String packageName) {
        ...
        final boolean isInstalled = SystemUtil.isAppInstalled(VipTaskPcddGameDetailActivity.this, packageName);
        if (isInstalled) {
            webView.post(new Runnable() {
                @Override
                public void run() {
...
//            Toast.makeText(this, message, Toast.LENGTH_SHORT).show();
    ...
    public void openBrowser(String url) {
        openBrowser(VipTaskPcddGameDetailActivity.this, url);
    }
...
//            Log.i("url:", "");
            ...
            mPermissionDialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("设置", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Uri packageURI = Uri.parse("package:" + getPackageName(VipTaskPcddGameDetailActivity.this));
    ...
    protected void installAPK(File file, String apkName) {
        ...
        Uri uri;
        if (VipTaskPcddGameDetailActivity.this == null || VipTaskPcddGameDetailActivity.this.isFinishing()) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            new RxPermissions(VipTaskPcddGameDetailActivity.this).request(Manifest.permission.REQUEST_INSTALL_PACKAGES).subscribe(new Consumer<Boolean>() {
                @Override
                public void accept(Boolean aBoolean) throws Exception {
                    if (aBoolean) {
                        ...
                        Toast.makeText(VipTaskPcddGameDetailActivity.this, "未授权权限，部分功能不能使用", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            File newPath = new File(VipTaskPcddGameDetailActivity.this.getFilesDir().getPath() + "/downloads");
            if (!newPath.exists()) {
