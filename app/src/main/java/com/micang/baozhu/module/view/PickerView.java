...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.color_3c3e5b);
        mDarkColor = ContextCompat.getColor(mContext, R.color.color_3c3e5b);
    }
