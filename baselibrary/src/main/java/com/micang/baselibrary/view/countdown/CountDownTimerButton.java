...
import com.micang.baselibrary.R;
...
public class CountDownTimerButton extends AppCompatButton {
    ...
    private int color = getResources().getColor(R.color.color_ff732e);
        ...
        if (mCountDownTimer == null) {
            mCountDownTimer = new CountDownTimer(mCount, mInterval) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    setText("重新发送" + "(" + String.format(Locale.CHINA, mCountDownFormat, currentCount) + ")");
                    setTextColor(color);
                }
